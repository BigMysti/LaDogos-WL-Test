    ...
    <main>
      <MainContainer className="maincontainer">
        <LeftContainer className="leftcontainer">
          <Image className="nft-image" src="yourimagehere.png" alt="Buy A whitelist" />
        </LeftContainer>
        <RightContainer className="rightcontainer">
          <MainTitle className="maintitle">
            WhiteList Token</MainTitle>
          <InfoContainer>
            <TotalItems className="totalitems">Total TOKENS {itemsAvailable}</TotalItems>
            <Price className="price">Price ◎ {isActive && whitelistEnabled && (whitelistTokenBalance > 0) ? (whitelistPrice + " ") : (price + " ")} </Price>
            <IconContainer>
              <IconLink className="infoIcon" href="https://ladogos.xyz/home" target="https://ladogos.xyz/home"> <InfoIcon src="website.svg" /> </IconLink>
              <IconLink className="infoIcon" href="https://discord.gg/LaDogos" target="https://discord.gg/LaDogos"> <InfoIcon src="discord.svg" /> </IconLink>
              <IconLink className="infoIcon" href="https://twitter.com/ladogosNFT" target="https://twitter.com/ladogosNFT"> <InfoIcon src="twitter.svg" /> </IconLink>
            </IconContainer>
          </InfoContainer>
          <ProjectDescription>Smoke testing shit for the WL token mint</ProjectDescription>
          <MintButtonContainer>
